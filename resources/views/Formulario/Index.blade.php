        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ul>
                        <li class="mb-3"><strong>Autorización: </strong>Consentimiento previo, expreso e informado del
                            Titular
                            para llevar a cabo el Tratamiento de Datos personales.</li>
                        <li class="mb-3"><strong>Aviso de Privacidad: </strong>comunicación verbal o escrita generada
                            por el
                        ...
                        <li class="mb-3"><strong>Bases de Datos: </strong>Conjunto organizado de datos personales que
                            sea objeto
                            de Tratamiento.</li>
                        <li class="mb-3"><strong>Dato Personal o Datos Personales: </strong>Cualquier información
                            vinculada o
                            que pueda asociarse a una o varias personas naturales determinadas o determinables.</li>
                        <li class="mb-3"><strong>Dato Público: </strong>Es el dato que no sea semiprivado, privado o
                            sensible.
                        ...
                        <li class="mb-3"><strong>Responsable del Tratamiento: </strong>Será la CONFEDERACIÓN DE GUÍAS DE
                            TURISMO
                            DE COLOMBIA CONFEGUIAS</li>
                        <li class="mb-3"><strong>Titular: </strong>Persona natural cuyos datos personales sean objeto de
                            tratamiento.</li>
                        <li class="mb-3"><strong>Tratamiento: </strong>Cualquier operación o conjunto de operaciones
                            sobre datos
                        ...
                        <li class="mb-3"><strong>Datos Sensibles: </strong>Se entiende por Datos sensibles aquellos que
                            afectan
                    ...
                    <p><strong>Página web: </strong><a href="http://https://confeguias.org/">https://confeguias.org/</a>
                    </p>
                    ...
                    <ul style="list-style:none">
                        <li class="mb-2"><strong>a)</strong> Conocer, actualizar y rectificar sus datos personales
                            frente a los
                        ...
                        <li class="mb-2"><strong>b)</strong> Solicitar prueba de la autorización otorgada al Responsable
                            del
                        ...
                        <li class="mb-2"><strong>c)</strong> Ser informado por el Responsable del Tratamiento o el
                            Encargado del
                            Tratamiento, previa solicitud, respecto del uso que le ha dado a sus datos personales.</li>
                        <li class="mb-2"><strong>d)</strong> Presentar ante la Superintendencia de Industria y Comercio
                            quejas
                            por infracciones a lo dispuesto en la Ley 1581 de 2012 y las demás normas que la modifiquen,
                            adicionen o complementen.</li>
                        <li class="mb-2"><strong>e)</strong> Revocar la autorización y/o solicitar la supresión del dato
                            cuando
                        ...
                        <li class="mb-2"><strong>f)</strong> Acceder en forma gratuita a sus datos personales que hayan
                            sido
                            objeto de Tratamiento.</li>
                        <li class="mb-2"><strong>g)</strong> Conocer el carácter facultativo de las respuestas a las
                            preguntas
